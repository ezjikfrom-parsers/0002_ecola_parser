...
def write_title_csv(ans):
    now = datetime.datetime.now();
    print('we write title' + 'result/all-{}.csv'.format((str(now.year) + '-' + str(now.month) + '-' + str(now.day))))
    with open('result/all-{}.csv'.format((str(now.year) + '-' + str(now.month) + '-' + str(now.day))), 'w', newline='', encoding='utf-8') as csv_file:
        writer = csv.writer(csv_file, delimiter=';');
...
def write_dict_in_csv(ans):
    now = datetime.datetime.now();
    #print('we write ' + 'result/all-{}.csv'.format((str(now.year) + '-' + str(now.month) + '-' + str(now.day))))
